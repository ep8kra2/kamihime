...
import { setAttackData } from '../../domain/calculate/service';
...
import { resultNormalAttackList } from '../../domain/calculate/normal/service';
import { resultBarstAttackList } from '../../domain/calculate/barst/service';
...
export const useAttackBarst = () => {
  ...
  // 通常攻撃リストを返します
  return resultBarstAttackList(useParameter,effectListWithAttack,useImpactList,elementList,listWeapon,listPhantom)
}