import { SelectedEffect, Parameter } from "../../../state/calculate/type"
import { Expression } from "../type"

export const subSkill5AttackUp:Expression= (effect:SelectedEffect,effectList:SelectedEffect[],parameter:Parameter):number => {
  return 5
}
